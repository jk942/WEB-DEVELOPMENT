...
// Object for icons to manage them centrally
export const icons = {
    Plane: Plane, 
    MapPin: MapPin, 
    Briefcase: Briefcase, 
...
export const mobilityPrograms = [
    {
        ...
        // Removed w-6 h-6, relying on parent component or base CSS for size
        icon: <Plane style={{ color: INTI_RED }} />,
    },
    {
        ...
        icon: <MapPin style={{ color: INTI_RED }} />,
    },
    {
        ...
        icon: <Briefcase style={{ color: INTI_RED }} />,
    },
];
...
export const footerLinks = [
    ...
    },
    {
        ...
        contact: {
            ...
            social: ['FB', 'IG', 'LI', 'YT'], // Added missing social icons for consistency
        },
    },
];
